...
let maxConcurrentConnections = 20
...
webApp.get('/script.js', function (req, res) {
...
webApp.get('/admin-style.css', function (req, res) {
  res.sendFile(__dirname + '/public/admin/admin-style.css')
})

webApp.get('/admin-script.js', function (req, res) {
  res.sendFile(__dirname + '/public/admin/admin-script.js')
})

webApp.get('/collect.mp3', function (req, res) {
  res.sendFile(__dirname + '/public/resources/collect.mp3')
})

webApp.get('/100-collect.mp3', function (req, res) {
  res.sendFile(__dirname + '/public/resources/100-collect.mp3')
})
